 ...
 * その代わり当方では一切責任を負いません。
 */
define("SRC_URL","https://www.concrete5.org/download_file/-/view/105022/");
define("VERSION","Ver. 8.4.1");
define("FILENAME","./concrete5-8.4.1.zip");
define("DIRNAME","./concrete5-8.4.1");
