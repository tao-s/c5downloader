 ...
 * その代わり当方では一切責任を負いません。
 */
define("SRC_URL","http://www.concrete5.org/download_file/-/view/92911/");
define("VERSION","Ver. 5.7.5.12");
define("FILENAME","./concrete5.7.5.12.zip");
define("DIRNAME","./concrete5.7.5.12");
