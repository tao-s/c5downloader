 ...
 * その代わり当方では一切責任を負いません。
 */
define("SRC_URL","https://www.concrete5.org/download_file/-/view/103182/");
define("VERSION","Ver. 8.4.0 RC2");
define("FILENAME","./concrete5-8.4.0RC2.zip");
define("DIRNAME","./concrete5-8.4.0RC2");
