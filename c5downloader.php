 ...
 * その代わり当方では一切責任を負いません。
 */
define("SRC_URL","http://www.concrete5.org/download_file/-/view/93797/");
define("VERSION","Ver. 8.1.0");
define("FILENAME","./concrete5-8.1.0.zip");
define("DIRNAME","./concrete5-8.1.0");
