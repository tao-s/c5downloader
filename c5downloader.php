...
define("SRC_URL","https://www.concretecms.com/download_file/29fd2f63-3f52-47d8-80a7-08be47d4ed07");
...
$messages = array(
    "ja" => array(
        ...
        "ダウンロード開始",
        "このディレクトリにConcreteCMSの圧縮ファイルをダウンロード中です。",
...
<title>ConcreteCMS Ver. <?php echo VERSION; ?> Downloader</title>
<style>
body{
    background: #EEE;
    margin:0;
...
<p class="step step2 center"><?php echo $messages[$lang][3]; ?></p>
<p class="step step3 center"><?php echo $messages[$lang][4]; ?></p>
...
<p class="step step4 center"><?php echo $messages[$lang][5]; ?></p>
</div>
<footer>copyright &copy; <?php echo date("Y");?> <a href="http://www.xross-cube.com/">XROSS CUBE, Inc.</a> All Rights Reserved.<br></footer>
