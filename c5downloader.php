 ...
 * その代わり当方では一切責任を負いません。
 */
define("SRC_URL","http://www.concrete5.org/download_file/-/view/100595/");
define("VERSION","Ver. 8.3.2");
define("FILENAME","./concrete5-8.3.2.zip");
define("DIRNAME","./concrete5-8.3.2");
