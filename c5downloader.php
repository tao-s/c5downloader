 ...
 * その代わり当方では一切責任を負いません。
 */
define("SRC_URL","https://www.concrete5.org/download_file/-/view/96765/");
define("VERSION","Ver. 8.2.0");
define("FILENAME","./concrete5-8.2.0.zip");
define("DIRNAME","./concrete5-8.2.0");
